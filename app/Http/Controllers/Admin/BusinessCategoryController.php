...
{
    private $data = array(
        'route' => 'admin.business_category.',
        'title' => 'Business Category',
        'menu' => 'business',
        'submenu' => 'business_category',
    );
    ...
    public function index(Request $request) {
        ...
        if ($request->ajax()) {
            $records = BusinessCategory::select('*')->orderBy('name','ASC');
    ...
    public function store(Request $request) {
        ...
        $inputs['image'] = $this->uploadFile($request, null, 'image', 'business_category');

        $record = new BusinessCategory($inputs);
        $record->save();
    ...
    public function update(Request $request, $id) {
      ...
      //  $this->_validate($request);
        ...
        $inputs = $request->all();
        $inputs['image'] = $this->uploadFile($request, $record, 'image', 'business_category');
